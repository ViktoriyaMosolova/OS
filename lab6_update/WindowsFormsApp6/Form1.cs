...
namespace WindowsFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        static List<IntPtr> EnumProcessWinHandle(Process process)
        {
        ...
        private void UpdatePage()
        {
            ...
            foreach (Process process in Gprocesseslist)
            {
                ...
                {
                    ListName.AddRange(EnumProcessWinHandle(process));
                }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                SendMessage(ListName[listBox1.SelectedIndex], WM_CLOSE, IntPtr.Zero, IntPtr.Zero);
            }
            catch
            {
